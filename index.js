...
shiki
    ...
    .then(h => {
        ...
        highlighter = h;
        console.log('time to initialise:', Date.now() - startH);
    });
...
document.getElementById('button').addEventListener('click', () => {
    ...
    let startHi = Date.now();
    pre.innerHTML = highlighter.codeToHtml(code, 'php');
    console.log('time to highlight', Date.now() - startHi);
});
